...
import WritingImage from "/src/assets/images/writing-image.jpg";
    ...
    >
      <div
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundColor: "rgba(0, 0, 0, .8)", // Adjust this value for transparency (0 is fully transparent, 1 is fully opaque)
        }}
      >
        <div
          style={{
