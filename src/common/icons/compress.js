...
export const CompressIcon = (props) => {
    const { style } = props;
    return (_jsxs("span", { className: "expand-icon", children: [_jsx(CompressOutlined, { style: style ? style : defaultIconColor }), _jsx("span", { className: "expand-text", children: "Compress" })] }));
};
